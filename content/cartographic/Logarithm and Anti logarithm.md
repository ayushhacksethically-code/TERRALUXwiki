...
- **Problem 2:** Calculate the antilog of 3.6552.
  - _Solution:_ Find the number whose logarithm is 3.6552. From the antilog table, the value corresponding to row 65 and column 5 is 4518. The mean difference column for the value 2 is 2. Adding these two values gives $4518 + 2 = 4520$. The decimal point is placed $3 + 1 = 4$ digits from the left. Thus, $\text{antilog } 3.6552 = 4520.0$.